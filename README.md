...
This tutorial teaches you some of the basic concepts in [Fusi Framework](https://fusi.com). It is meant to be a fast read for learning how to get started - not an example on how application should be
